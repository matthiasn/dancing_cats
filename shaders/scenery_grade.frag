...
//   graded = (graded - pivot) * contrast + pivot     // contrast about a pivot
...
// gamma (moves midtones), so the three map onto a 3-way colour-wheel UI. Contrast
// rotates the tone about a mid-grey pivot to shape the curve the offset-only
// wheels can't. Uniform order MUST match BackdropGradePainter's setFloat calls.
