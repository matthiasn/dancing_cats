...
const _shakuHandRTargetKeys = [
  ...
  DanceIkTargetKey(4, x: 44, y: -42), // HIT open-out
  DanceIkTargetKey(8, x: -8, y: -14),
  DanceIkTargetKey(12, x: 44, y: -42),
