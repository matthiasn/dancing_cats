...
const _azontoHandLTargetKeys = [
  ...
  DanceIkTargetKey(0, x: -8, y: -42),
  DanceIkTargetKey(2, x: -8, y: -28),
  DanceIkTargetKey(4, x: -8, y: -42),
  DanceIkTargetKey(6, x: -8, y: -56),
  DanceIkTargetKey(8, x: -8, y: -42),
  DanceIkTargetKey(10, x: -8, y: -28),
  DanceIkTargetKey(12, x: -8, y: -42),
  DanceIkTargetKey(14, x: -8, y: -56),
  DanceIkTargetKey(16, x: -8, y: -42),
  DanceIkTargetKey(18, x: -8, y: -28),
  DanceIkTargetKey(20, x: -8, y: -42),
  DanceIkTargetKey(22, x: -8, y: -56),
  DanceIkTargetKey(24, x: -8, y: -42),
  DanceIkTargetKey(26, x: -8, y: -28),
  DanceIkTargetKey(28, x: -8, y: -42),
  DanceIkTargetKey(30, x: -8, y: -56),
  DanceIkTargetKey(32, x: -8, y: -42),
];
const _azontoHandRTargetKeys = [
  DanceIkTargetKey(0, x: 8, y: -42),
  DanceIkTargetKey(2, x: 8, y: -56),
  DanceIkTargetKey(4, x: 8, y: -42),
  DanceIkTargetKey(6, x: 8, y: -28),
  DanceIkTargetKey(8, x: 8, y: -42),
  DanceIkTargetKey(10, x: 8, y: -56),
  DanceIkTargetKey(12, x: 8, y: -42),
  DanceIkTargetKey(14, x: 8, y: -28),
  DanceIkTargetKey(16, x: 8, y: -42),
  DanceIkTargetKey(18, x: 8, y: -56),
  DanceIkTargetKey(20, x: 8, y: -42),
  DanceIkTargetKey(22, x: 8, y: -28),
  DanceIkTargetKey(24, x: 8, y: -42),
  DanceIkTargetKey(26, x: 8, y: -56),
  DanceIkTargetKey(28, x: 8, y: -42),
  DanceIkTargetKey(30, x: 8, y: -28),
  DanceIkTargetKey(32, x: 8, y: -42),
];
