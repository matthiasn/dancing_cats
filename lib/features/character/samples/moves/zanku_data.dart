...
const _zankuFootLTargetKeys = [
  ...
  DanceIkTargetKey(5, x: -46, y: 78), // compact pickup, clearly airborne (R5: taller lift)
...
const _zankuPocketBoostKeys = [
  ...
  DanceBodyKey(2, rootDy: -3.6, pelvisRotation: -0.02, chestRotation: 0.02),
  DanceBodyKey(
    4,
    rootDy: 12.6,
    pelvisRotation: 0.07,
  ...
  DanceBodyKey(6, rootDy: -3.6, pelvisRotation: 0.02, chestRotation: -0.02),
  DanceBodyKey(
    8,
    rootDy: 10.8,
    pelvisRotation: -0.07,
  ...
  DanceBodyKey(10, rootDy: -3.6, pelvisRotation: -0.02, chestRotation: 0.02),
  DanceBodyKey(
    12,
    rootDy: 12.6,
    pelvisRotation: 0.07,
  ...
  DanceBodyKey(14, rootDy: -3.6, pelvisRotation: 0.02, chestRotation: -0.02),
  DanceBodyKey(
    16,
    rootDy: 10.8,
    pelvisRotation: -0.07,
  ...
  DanceBodyKey(18, rootDy: -3.6, pelvisRotation: -0.02, chestRotation: 0.02),
  DanceBodyKey(
    20,
    rootDy: 12.6,
    pelvisRotation: 0.07,
  ...
  DanceBodyKey(22, rootDy: -3.6, pelvisRotation: 0.02, chestRotation: -0.02),
  DanceBodyKey(
    24,
    rootDy: 14.4,
    pelvisRotation: -0.08,
