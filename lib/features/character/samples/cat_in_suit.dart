...
class CatClips {
  ...
  static const _pounceBodyKeys = [
    ...
    DanceBodyKey(18, rootDx: 14, rootDy: 54, pelvisRotation: 0.2),
    DanceBodyKey(
      20,
      rootDx: 20,
      rootDy: 80,
  ...
  static const _pounceFootLTargetKeys = [
    ...
    DanceIkTargetKey(12, x: 0, y: 101),
    DanceIkTargetKey(14, x: -38, y: 100),
    ...
    DanceIkTargetKey(28, x: -112, y: 101),
  ...
  static const _pounceFootRTargetKeys = [
    ...
    DanceIkTargetKey(12, x: 112, y: 101),
    ...
    DanceIkTargetKey(28, x: 0, y: 101),
    DanceIkTargetKey(30, x: 38, y: 100),
    DanceIkTargetKey(32, x: 54, y: 100),
  ];
