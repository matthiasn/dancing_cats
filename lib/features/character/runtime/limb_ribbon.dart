...
/// elbow); 1 = the raw polyline (a cardboard hinge). ~0.45 keeps the surface
/// smooth while concentrating the visible bend AT the joint, so an elbow
/// reads as an elbow.
...
Offset _catmullRom(Offset p0, Offset p1, Offset p2, Offset p3, double t) {
  final t2 = t * t;
  final t3 = t2 * t;
  final scale = (1 - _kCentrelineTension) * 0.5;
