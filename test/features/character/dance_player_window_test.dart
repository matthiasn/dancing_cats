...
class _WindowConfig {
  ...
  factory _WindowConfig.fromEnv(Map<String, String> env) {
    ...
    return _WindowConfig(
      ...
      beatMapPath: env['DANCE_BEATMAP'] ?? 'assets/sample_track/moving.json',
      wordsPath: env['DANCE_WORDS'] ?? 'assets/sample_track/moving.words.json',
      cuesPath: env['DANCE_CUES'] ?? 'assets/sample_track/moving.cues.json',
    );
  }
