...
const String _defaultBeatMapPath = 'assets/sample_track/moving.json';
const String _defaultWordsPath = 'assets/sample_track/moving.words.json';
const String _defaultCuesPath = 'assets/sample_track/moving.cues.json';
